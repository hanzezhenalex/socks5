...
// WithUser adds the user to the post login params
func (o *PostLoginParams) WithUser(user *models.User) *PostLoginParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the post login params
func (o *PostLoginParams) SetUser(user *models.User) {
	o.User = user
}
